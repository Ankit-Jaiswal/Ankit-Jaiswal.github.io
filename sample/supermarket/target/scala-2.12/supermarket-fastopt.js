...
/** @constructor */
function $c_Lsupermarket_shop$Item() {
  $c_O.call(this);
  this.name$1 = null;
  this.spec$1 = null;
  this.imgname$1 = null;
...
$c_Lsupermarket_shop$Item.prototype = new $h_O();
$c_Lsupermarket_shop$Item.prototype.constructor = $c_Lsupermarket_shop$Item;
/** @constructor */
function $h_Lsupermarket_shop$Item() {
  /*<skip>*/
}
$h_Lsupermarket_shop$Item.prototype = $c_Lsupermarket_shop$Item.prototype;
$c_Lsupermarket_shop$Item.prototype.productPrefix__T = (function() {
  return "Item"
});
$c_Lsupermarket_shop$Item.prototype.productArity__I = (function() {
  return 5
});
$c_Lsupermarket_shop$Item.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lsupermarket_shop$Item(x$1)) {
    var Item$1 = $as_Lsupermarket_shop$Item(x$1);
    return (((((this.name$1 === Item$1.name$1) && (this.spec$1 === Item$1.spec$1)) && (this.imgname$1 === Item$1.imgname$1)) && (this.mrp$1 === Item$1.mrp$1)) && (this.price$1 === Item$1.price$1))
  } else {
    return false
  }
});
$c_Lsupermarket_shop$Item.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.name$1;
      break
...
$c_Lsupermarket_shop$Item.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lsupermarket_shop$Item.prototype.init___T__T__T__D__D = (function(name, spec, imgname, mrp, price) {
  this.name$1 = name;
  this.spec$1 = spec;
  this.imgname$1 = imgname;
  this.mrp$1 = mrp;
  this.price$1 = price;
  return this
});
$c_Lsupermarket_shop$Item.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.name$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.spec$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.imgname$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.mrp$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.price$1));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 5)
});
$c_Lsupermarket_shop$Item.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lsupermarket_shop$Item(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lsupermarket_shop$Item)))
}
function $as_Lsupermarket_shop$Item(obj) {
  return (($is_Lsupermarket_shop$Item(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "supermarket.shop$Item"))
}
function $isArrayOf_Lsupermarket_shop$Item(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lsupermarket_shop$Item)))
}
function $asArrayOf_Lsupermarket_shop$Item(obj, depth) {
  return (($isArrayOf_Lsupermarket_shop$Item(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lsupermarket.shop$Item;", depth))
}
var $d_Lsupermarket_shop$Item = new $TypeData().initClass({
  Lsupermarket_shop$Item: 0
}, false, "supermarket.shop$Item", {
  Lsupermarket_shop$Item: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lsupermarket_shop$Item.prototype.$classData = $d_Lsupermarket_shop$Item;
/** @constructor */
function $c_Lsupermarket_shopping$() {
  $c_O.call(this);
  this.colgate$1 = null;
  this.maggie$1 = null;
  this.amulGold$1 = null;
  this.glucose$1 = null;
  this.chini$1 = null;
  this.tataNamak$1 = null;
  this.tataChaiPrem$1 = null;
  this.itmlst$1 = null
}
$c_Lsupermarket_shopping$.prototype = new $h_O();
$c_Lsupermarket_shopping$.prototype.constructor = $c_Lsupermarket_shopping$;
/** @constructor */
function $h_Lsupermarket_shopping$() {
  /*<skip>*/
}
$h_Lsupermarket_shopping$.prototype = $c_Lsupermarket_shopping$.prototype;
$c_Lsupermarket_shopping$.prototype.init___ = (function() {
  $n_Lsupermarket_shopping$ = this;
  this.colgate$1 = new $c_Lsupermarket_shop$Item().init___T__T__T__D__D("Colgate Toothpaste", "200gm", "./pics/colgate.jpg", 74.5, 70.0);
  this.maggie$1 = new $c_Lsupermarket_shop$Item().init___T__T__T__D__D("Nestle Maggie", "pack of 4", "./pics/namaste.jpg", 96.0, 94.5);
  this.amulGold$1 = new $c_Lsupermarket_shop$Item().init___T__T__T__D__D("Amul Gold milk", "500ml", "./pics/namaste.jpg", 25.0, 24.0);
  this.glucose$1 = new $c_Lsupermarket_shop$Item().init___T__T__T__D__D("GluconD", "Orange", "./pics/paneer.jpg", 64.0, 60.0);
  this.chini$1 = new $c_Lsupermarket_shop$Item().init___T__T__T__D__D("Sugar", "2kg", "./pics/sugar.jpg", 56.0, 53.5);
  this.tataNamak$1 = new $c_Lsupermarket_shop$Item().init___T__T__T__D__D("Tata Salt", "1Kg", "./pics/namaste.jpg", 15.0, 10.0);
  this.tataChaiPrem$1 = new $c_Lsupermarket_shop$Item().init___T__T__T__D__D("Tata Tea Premium", "250gm", "./pics/bru.jpg", 132.0, 129.0);
  var this$1 = $m_s_package$().Vector$1;
  var array = [this.colgate$1, this.maggie$1, this.amulGold$1, this.glucose$1, this.chini$1, this.tataNamak$1, this.tataChaiPrem$1];
...
$c_Lsupermarket_shopping$.prototype.productPrefix__T = (function() {
  return "shopping"
});
$c_Lsupermarket_shopping$.prototype.productArity__I = (function() {
  return 0
});
$c_Lsupermarket_shopping$.prototype.createItmbox$1__p1__Lsupermarket_shop$Item__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_Node = (function(itm, target$1) {
  var this$1 = $m_Lscalatags_JsDom$all$();
  var jsx$28 = this$1.div__Lscalatags_JsDom$TypedTag();
  var this$2 = $m_Lscalatags_JsDom$all$();
  var jsx$27 = this$2.table__Lscalatags_JsDom$TypedTag();
  var this$3 = $m_Lscalatags_JsDom$all$();
  var jsx$26 = this$3.td__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().width__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair("200px", $m_Lscalatags_JsDom$all$().stringPixelStyle$1)]));
  var this$4 = $m_Lscalatags_JsDom$all$();
  var jsx$25 = jsx$26.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this$4.img__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().src__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(itm.imgname$1, $m_Lscalatags_JsDom$all$().stringAttr$1)]))]));
  var this$5 = $m_Lscalatags_JsDom$all$();
  var jsx$24 = this$5.td__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().width__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair("350px", $m_Lscalatags_JsDom$all$().stringPixelStyle$1)]));
  var this$6 = $m_Lscalatags_JsDom$all$();
  var jsx$23 = this$6.h3__Lscalatags_JsDom$TypedTag();
  ...
  var jsx$21 = this$8.p__Lscalatags_JsDom$TypedTag();
  $m_Lscalatags_JsDom$all$();
  var v$1 = itm.spec$1;
  var jsx$20 = jsx$24.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$22, jsx$21.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_JsDom$StringFrag().init___T(v$1)]))]));
  var this$10 = $m_Lscalatags_JsDom$all$();
  var jsx$19 = this$10.td__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().width__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair("300px", $m_Lscalatags_JsDom$all$().stringPixelStyle$1)]));
  var this$11 = $m_Lscalatags_JsDom$all$();
  var jsx$18 = this$11.select__Lscalatags_JsDom$TypedTag();
  var this$12 = $m_Lscalatags_JsDom$all$();
  var jsx$17 = this$12.option__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Seller 1"))]));
  var this$14 = $m_Lscalatags_JsDom$all$();
  var jsx$16 = this$14.option__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Seller 2"))]));
  var this$16 = $m_Lscalatags_JsDom$all$();
  var jsx$15 = jsx$18.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$17, jsx$16, this$16.option__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Seller 3"))]))]));
  var this$18 = $m_Lscalatags_JsDom$all$();
  var jsx$14 = this$18.br__Lscalatags_JsDom$TypedTag();
  var this$19 = $m_Lscalatags_JsDom$all$();
  var jsx$13 = this$19.br__Lscalatags_JsDom$TypedTag();
  var this$20 = $m_Lscalatags_JsDom$all$();
  var jsx$12 = this$20.br__Lscalatags_JsDom$TypedTag();
  var this$21 = $m_Lscalatags_JsDom$all$();
  var jsx$11 = this$21.del__Lscalatags_JsDom$TypedTag();
  $m_Lscalatags_JsDom$all$();
  var jsx$10 = new $c_Lscalatags_JsDom$StringFrag().init___T(" Rs. ");
  $m_Lscalatags_JsDom$all$();
  var v$2 = itm.mrp$1;
  var v$3 = ("" + v$2);
  var jsx$9 = jsx$11.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$10, new $c_Lscalatags_JsDom$StringFrag().init___T(v$3)]));
  var this$25 = $m_Lscalatags_JsDom$all$();
  var jsx$8 = this$25.h4__Lscalatags_JsDom$TypedTag();
  $m_Lscalatags_JsDom$all$();
  var jsx$7 = new $c_Lscalatags_JsDom$StringFrag().init___T(" Rs. ");
  $m_Lscalatags_JsDom$all$();
  var v$4 = itm.price$1;
  var v$5 = ("" + v$4);
  var jsx$6 = jsx$19.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$15, jsx$14, jsx$13, jsx$12, jsx$9, jsx$8.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$7, new $c_Lscalatags_JsDom$StringFrag().init___T(v$5)]))]));
  var this$29 = $m_Lscalatags_JsDom$all$();
  var jsx$5 = this$29.td__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().width__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair("150px", $m_Lscalatags_JsDom$all$().stringPixelStyle$1), $m_Lscalatags_JsDom$all$().style__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("vertical-align: middle;text-align:center", $m_Lscalatags_JsDom$all$().stringAttr$1)]));
  var this$30 = $m_Lscalatags_JsDom$all$();
  var jsx$4 = this$30.h5__Lscalatags_JsDom$TypedTag();
  var this$31 = $m_Lscalatags_JsDom$all$();
  var jsx$3 = this$31.button__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T(" - "))]));
  $m_Lscalatags_JsDom$all$();
  var jsx$2 = new $c_Lscalatags_JsDom$StringFrag().init___T(" 0 ");
  var this$34 = $m_Lscalatags_JsDom$all$();
  var jsx$1 = jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$3, jsx$2, this$34.button__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T(" + "))]))]));
  var this$36 = $m_Lscalatags_JsDom$all$();
  return target$1.appendChild(jsx$28.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$27.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$25, jsx$20, jsx$6, jsx$5.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$1, this$36.h6__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Subtotal: Rs. 0"))]))]))]))])).render__Lorg_scalajs_dom_raw_Element())
});
$c_Lsupermarket_shopping$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lsupermarket_shopping$.prototype.toString__T = (function() {
  return "shopping"
});
$c_Lsupermarket_shopping$.prototype.main__AT__V = (function(args) {
  /*<skip>*/
});
$c_Lsupermarket_shopping$.prototype.$$js$exported$meth$loadItems__Lorg_scalajs_dom_raw_HTMLDivElement__O = (function(target) {
  this.createItmbox$1__p1__Lsupermarket_shop$Item__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_Node(this.tataChaiPrem$1, target)
});
$c_Lsupermarket_shopping$.prototype.hashCode__I = (function() {
  return (-344460952)
});
$c_Lsupermarket_shopping$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lsupermarket_shopping$.prototype.loadItems = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$loadItems__Lorg_scalajs_dom_raw_HTMLDivElement__O(prep0)
});
var $d_Lsupermarket_shopping$ = new $TypeData().initClass({
  Lsupermarket_shopping$: 0
}, false, "supermarket.shopping$", {
  Lsupermarket_shopping$: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lsupermarket_shopping$.prototype.$classData = $d_Lsupermarket_shopping$;
var $n_Lsupermarket_shopping$ = (void 0);
function $m_Lsupermarket_shopping$() {
  if ((!$n_Lsupermarket_shopping$)) {
    $n_Lsupermarket_shopping$ = new $c_Lsupermarket_shopping$().init___()
  };
  return $n_Lsupermarket_shopping$
}
/** @constructor */
...
$c_Lscalatags_JsDom$all$.prototype.h5$lzycompute__p1__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (2048 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.h5$1 = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "h5", false, ns));
...
$c_Lscalatags_JsDom$all$.prototype.select__Lscalatags_JsDom$TypedTag = (function() {
  ...
  var lo = (512 & b.lo$2);
  if ((lo === 0)) {
    return this.select$lzycompute__p1__Lscalatags_JsDom$TypedTag()
  } else {
...
$c_Lscalatags_JsDom$all$.prototype.option__Lscalatags_JsDom$TypedTag = (function() {
  ...
  var lo = (4096 & b.lo$2);
  if ((lo === 0)) {
    return this.option$lzycompute__p1__Lscalatags_JsDom$TypedTag()
  } else {
    return this.option$1
  }
});
$c_Lscalatags_JsDom$all$.prototype.h6$lzycompute__p1__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (4096 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.h6$1 = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "h6", false, ns));
    var b$1 = this.bitmap$0$1;
...
$c_Lscalatags_JsDom$all$.prototype.select$lzycompute__p1__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$1$1;
  var lo = (512 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.select$1 = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "select", false, ns));
    var b$1 = this.bitmap$1$1;
...
$c_Lscalatags_JsDom$all$.prototype.h5__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (2048 & b.lo$2);
  if ((lo === 0)) {
    return this.h5$lzycompute__p1__Lscalatags_JsDom$TypedTag()
  } else {
    return this.h5$1
  }
});
$c_Lscalatags_JsDom$all$.prototype.del__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$0$1;
  var hi = (4096 & b.hi$2);
  if ((hi === 0)) {
    return this.del$lzycompute__p1__Lscalatags_JsDom$TypedTag()
  } else {
    return this.del$1
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.h6__Lscalatags_JsDom$TypedTag = (function() {
  ...
  var lo = (4096 & b.lo$2);
  if ((lo === 0)) {
    return this.h6$lzycompute__p1__Lscalatags_JsDom$TypedTag()
  } else {
    return this.h6$1
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.del$lzycompute__p1__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$0$1;
  var hi = (4096 & b.hi$2);
  if ((hi === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.del$1 = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "del", false, ns));
    var b$1 = this.bitmap$0$1;
    var lo = b$1.lo$2;
...
$c_Lscalatags_JsDom$all$.prototype.h4$lzycompute__p1__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (1024 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
...
$c_Lscalatags_JsDom$all$.prototype.h4__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (1024 & b.lo$2);
  if ((lo === 0)) {
...
$c_Lscalatags_JsDom$all$.prototype.option$lzycompute__p1__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$1$1;
  var lo = (4096 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.option$1 = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "option", false, ns));
    var b$1 = this.bitmap$1$1;
    var lo$1 = (4096 | b$1.lo$2);
    var hi = b$1.hi$2;
    this.bitmap$1$1 = new $c_sjsr_RuntimeLong().init___I__I(lo$1, hi)
...
$e.shopping = $m_Lsupermarket_shopping$();
$m_Lsupermarket_shopping$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=supermarket-fastopt.js.map
